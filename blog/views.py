...
class ArticleListCreateAPIView(ListCreateAPIView):
    ...
    def get_queryset(self):
        ...
        return Article.objects.filter(query).order_by("-updated_at","-created_at")
...
class ArticlePublishAPIView(GenericAPIView):
    ...
    queryset = Article.objects.filter(status__in=[Article.DRAFT, Article.PENDING]).order_by("-created_at","-updated_at")
    serializer_class = ArticleSerializer
...
class CourseListCreateAPIView(ListCreateAPIView):
    ...
    def get_queryset(self):
        ...
        return Course.objects.filter(status=Course.PUBLISHED).order_by("-updated_at","-created_at")
